...
@livewire('frontend.dashboard.content.first-row')
{{-- @livewire('frontend.dashboard.content.second-row') --}}
{{-- <div class="block block--highlighted block-categories block-categories--layout--compact">
    <div class="container">
        <div class="block-header">
            <h3 class="block-header__title">Product Categories</h3>
            ...
            <div class="block-categories__item category-card category-card--layout--compact">
                <div class="category-card__body">
                    <div class="category-card__image">
                        <img src="/frontend/images/categories/category-1.jpg" alt="">
                    </div>
                    <div class="category-card__content">
                        <div class="category-card__name">
                            <a href="">{{ $c->product_category_name }}</a>
                        </div>
                    </div>
                </div>
            </div>
