            ...
            <div class="col-9">
                <div class="card mb-0">
                    <div class="card-body">
                        ...
                        <h1>{{ $orders->orders_invoice }}</h1>
                        <p>Payment Status : {{ $orders->orders_payment_status }}</p>
                        <p>Order Status : {{ $orders->orders_status }}</p>
                        <hr>
                        ...
                        <table class="checkout__totals">
                            ...
                            <tbody class="checkout__totals-subtotals ">
                                <tr>
                                    ...
                                    <td>
                                        {{ $address->customer_address_name. ' - '. $address->customer_address_address }}
                                    </td>
                                </tr>
                            </tbody>
                            <tbody class="checkout__totals-subtotals ">
