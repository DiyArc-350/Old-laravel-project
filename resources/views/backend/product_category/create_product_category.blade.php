    ...
    <div class="card-body pt-0">
        ...
        <div class="col-md-12">
            <div class="mb-3">
                ...
                <input name="product_category_name" type="text" class="form-control" id="formrow-inputCity" required value="" placeholder=" Input Category ">
            </div>
        </div>
        <div class="col-md-12">
            <div class="mb-3">
                <label for="formrow-inputCity" class="form-label">Parent</label>
                <input name="product_category_parent" type="text" class="form-control" id="formrow-inputCity" required value="" placeholder=" Input Parent ">
            </div>
        </div>
        <div class="col-md-12">
            <div class="mb-3">
                <label for="formrow-inputCity" class="form-label">Sort</label>
                <input name="product_category_sort" type="text" class="form-control" id="formrow-inputCity" required value="" placeholder=" Input Sort">
            </div>
        </div>
        <div class="col-md-12">
            <div class="mb-3">
                <label for="formrow-inputCity" class="form-label">Information</label>
                <input name="product_category_info" type="text" class="form-control" id="formrow-inputCity" required value="" placeholder="Input Information">
            </div>
        </div>
